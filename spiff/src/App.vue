		...
		>
			...
			<nav class="flex-1 overflow-y-auto pt-4" :class="collapsed ? 'px-1.5' : 'px-4'">
				...
				<router-link
					...
					:class="[
						collapsed ? 'justify-center p-2.5' : 'gap-3 px-4 py-2.5',
						$route.path.startsWith('/processa/runs') ? 'bg-gray-900 text-white shadow-md' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'
					]"
					@click="isMobileMenuOpen = false"
					:title="collapsed ? 'Runs' : ''"
				>
					<Icon icon="lucide:list-tree" class="w-5 h-5 shrink-0" />
					<span
						class="text-sm font-semibold whitespace-nowrap transition-opacity duration-200 overflow-hidden"
						:class="collapsed ? 'opacity-0 w-0' : 'opacity-100 w-auto'"
					>
				...
				<router-link
					...
					:class="[
						collapsed ? 'justify-center p-2.5' : 'gap-3 px-4 py-2.5',
						$route.path.startsWith('/processa/evals') ? 'bg-gray-900 text-white shadow-md' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'
					]"
					@click="isMobileMenuOpen = false"
					:title="collapsed ? 'Evals' : ''"
				>
					<Icon icon="lucide:clipboard-check" class="w-5 h-5 shrink-0" />
					<span
						class="text-sm font-semibold whitespace-nowrap transition-opacity duration-200 overflow-hidden"
						:class="collapsed ? 'opacity-0 w-0' : 'opacity-100 w-auto'"
					>
				...
				<router-link
					...
					:class="[
						collapsed ? 'justify-center p-2.5' : 'gap-3 px-4 py-2.5',
						$route.path.startsWith('/processa/skills') ? 'bg-gray-900 text-white shadow-md' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'
					]"
					@click="isMobileMenuOpen = false"
					:title="collapsed ? 'Skills' : ''"
				>
					<Icon icon="lucide:brain-circuit" class="w-5 h-5 shrink-0" />
					<span
						class="text-sm font-semibold whitespace-nowrap transition-opacity duration-200 overflow-hidden"
						:class="collapsed ? 'opacity-0 w-0' : 'opacity-100 w-auto'"
					>
