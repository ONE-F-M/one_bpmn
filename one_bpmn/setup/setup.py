...
from one_bpmn.setup.custom_field import get_custom_fields
from one_bpmn.setup.property_setter import get_field_properties
from one_bpmn.setup.workflow import create_workflows, delete_workflows
from one_bpmn.setup.assignment_rule import create_assignment_rules, delete_assignment_rules
...
def delete_custom_fields(custom_fields: dict):
	"""
	:param custom_fields: a dict like `{'Comment': [{fieldname: 'is_processa_comment', ...}]}`
	"""
