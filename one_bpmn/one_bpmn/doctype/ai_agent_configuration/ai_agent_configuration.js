...
frappe.ui.form.on("AI Agent Configuration", {
	refresh(frm) {
		...
		// The Chat test button was removed by decision (2026-08-11) — agents
		// are exercised on their real surfaces (the Processa panels). The
		// window.oneAI.openAgentChat dialog itself still exists for
		// programmatic use; only this entry point is gone.
	},
