...
"""The agent sandbox connector's operations: sandbox_dispatch (the bare HTTP primitive for the fast, synchronous file-op tools) and dispatch_action (one generic handler serving every slow, parked operation the sandbox exposes).
