...
def execute():
	"""Point at the dedicated Logix – Clarifier config instead of the shared
	Logix config's Sub Prompts row being retired. Must run after
	...
	if OLD not in script:
		frappe.log_error(
			title="switch_logix_clarify_to_dedicated_config: anchor not found",
