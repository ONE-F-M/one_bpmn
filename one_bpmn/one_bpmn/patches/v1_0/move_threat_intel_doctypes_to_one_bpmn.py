"""
WI-002203: Move the Threat Source Discovery doctypes from onefm_mcp into one_bpmn.
...
so no data moves. Mirrors move_agent_chat_doctypes_to_one_bpmn (WI-001613).
"""
